...
export const CODE_FONT_FAMILY_CHANGE_EVENT = "code-font-family-change";
...
export function resolveAppFontFamily(value: string): string {
  return normalizeFontFamily(value) || DEFAULT_APP_FONT_FAMILY;
}

export function resolveChatFontFamily(value: string): string {
  return normalizeFontFamily(value) || DEFAULT_CHAT_FONT_FAMILY;
}
