...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.providerUsageMode.balance": "余额适配器",
    "settings.providerUsageMode.codingPlan": "Coding Plan",
    ...
    "settings.providerUsageTemplate.general": "使用内置通用余额模板和当前供应商 API Key。",
    "settings.providerUsageTemplate.newapi": "使用内置 NewAPI 模板；可选择单独配置查询地址与凭据。",
    "settings.providerUsageScript": "自定义查询脚本",
  ...
  "en-US": {
    ...
    "settings.providerUsageMode.balance": "Balance adapter",
    "settings.providerUsageMode.codingPlan": "Coding Plan",
    ...
    "settings.providerUsageTemplate.general":
      "Uses the built-in general balance template with this provider's API key.",
    "settings.providerUsageTemplate.newapi":
      "Uses the built-in NewAPI template; optionally configure a separate query URL and credentials.",
    "settings.providerUsageScript": "Custom query script",
