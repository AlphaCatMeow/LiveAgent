...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.skills.commandDescription": "切换当前会话的 Skills 方案",
    "chat.skills.commandMenuTitle": "Skills 方案",
    "chat.skills.commandPresetDescription": "向模型暴露此方案中的 Skills",
    ...
    "chat.inputHintWithSkills":
      "输入消息，@ 引用文件，/ 设置方案或引用 Skills，提示词可队列发送...",
