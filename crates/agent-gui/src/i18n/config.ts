...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.skills.presetTooltip": "选择 Skill 预设",
    "chat.skills.disabledForConversation": "本会话关闭",
    "chat.skills.commandDescription": "切换当前会话的 Skill 预设",
    "chat.skills.commandMenuTitle": "Skill 预设",
    "chat.skills.commandPresetDescription": "向模型暴露此预设中的 Skills",
    "chat.skills.commandDisabledDescription": "不向模型暴露 Skills",
    ...
    "chat.inputHintWithSkills":
      "输入消息，@ 引用文件，/ 设置预设或引用 Skills，提示词可队列发送...",
    ...
    "settings.cronSkillPresetLabel": "Skill 预设",
    ...
    "settings.skillsPresetLabel": "Skill 预设",
    "settings.skillsPresetCreate": "新建预设",
    "settings.skillsPresetDuplicate": "复制预设",
    "settings.skillsPresetRename": "重命名预设",
    "settings.skillsPresetDelete": "删除预设",
    "settings.skillsPresetUntitled": "新预设",
    "settings.skillsPresetCopySuffix": "副本",
    "settings.skillsPresetRenamePrompt": "输入新的预设名称",
    "settings.skillsPresetNameExists": "预设名称已存在",
    "settings.skillsPresetDeleteConfirm": "删除此预设？引用它的会话和 Cron 将回退到 Default。",
    "settings.skillsPresetEmptyShort": "暂无自定义预设",
    "settings.skillsPresetEmptyTitle": "还没有自定义 Skill 预设",
    "settings.skillsPresetEmptyDesc": "创建预设后，从已安装 Skill 中选择要向模型暴露的能力。",
    "settings.skillsPresetEditingHint": "正在配置“{name}”，成员仅来自已安装 Skill",
    "settings.skillsPresetDefaultHint": "这里配置新会话默认使用的 Default 预设",
    "settings.skillsPresetSectionTitle": "Skill 预设",
    "settings.skillsPresetSectionDescription":
      "创建可复用的 Skill 组合，并在会话或 Cron 中按需选择。",
    "settings.skillsPresetDefaultDescription":
      "与“已安装”中启用的 Skills 保持一致，只能回到已安装页面修改。",
    "settings.skillsPresetDescriptionFallback": "尚未添加描述",
    "settings.skillsPresetDefaultBadge": "默认",
    "settings.skillsPresetSkillCount": "{count} 个 Skills",
    "settings.skillsPresetEditorTitle": "编辑 Skill 预设",
    "settings.skillsPresetReadOnlyTitle": "只读预设",
    "settings.skillsPresetGoInstalled": "前往已安装",
    "settings.skillsPresetNameLabel": "预设名称",
    "settings.skillsPresetNamePlaceholder": "例如：代码审查",
    "settings.skillsPresetNameRequired": "请输入预设名称",
    "settings.skillsPresetDescriptionLabel": "简短描述",
    "settings.skillsPresetDescriptionPlaceholder": "说明这个预设适合什么任务",
    "settings.skillsPresetMembersTitle": "包含的 Skills",
    "settings.skillsPresetSelectedCount": "已选择 {count} 个",
    "settings.skillsPresetSelectedOnly": "仅看已选择",
    "settings.skillsPresetSearchPlaceholder": "按名称搜索已安装 Skill",
    "settings.skillsPresetCategoryLabel": "Skill 分类",
    "settings.skillsPresetNoSkillsMatch": "没有符合当前条件的 Skill",
    ...
    "settings.skillsHubPresetsTab": "Skill 预设",
  ...
  "en-US": {
    ...
    "chat.skills.commandDescription": "Change the Skills preset for this chat",
    "chat.skills.commandMenuTitle": "Skills presets",
    "chat.skills.commandPresetDescription": "Expose this preset's Skills to the model",
    "chat.skills.commandDisabledDescription": "Do not expose Skills to the model",
    ...
    "chat.inputHintWithSkills":
      "Type a message, @ for files, / to set a Skills preset or reference a Skill, prompts can be queued...",
    ...
    "settings.skillsPresetSectionTitle": "Skill presets",
    "settings.skillsPresetSectionDescription":
      "Create reusable Skill combinations for conversations and Cron tasks.",
    "settings.skillsPresetDefaultDescription":
      "Matches the Skills enabled under Installed and can only be changed from that page.",
    "settings.skillsPresetDescriptionFallback": "No description yet",
    "settings.skillsPresetDefaultBadge": "Default",
    "settings.skillsPresetSkillCount": "{count} Skills",
    "settings.skillsPresetEditorTitle": "Edit Skill preset",
    "settings.skillsPresetReadOnlyTitle": "Read-only preset",
    "settings.skillsPresetGoInstalled": "Go to Installed",
    "settings.skillsPresetNameLabel": "Preset name",
    "settings.skillsPresetNamePlaceholder": "For example: Code review",
    "settings.skillsPresetNameRequired": "Enter a preset name",
    "settings.skillsPresetDescriptionLabel": "Short description",
    "settings.skillsPresetDescriptionPlaceholder": "Describe which tasks this preset is for",
    "settings.skillsPresetMembersTitle": "Included Skills",
    "settings.skillsPresetSelectedCount": "{count} selected",
    "settings.skillsPresetSelectedOnly": "Selected only",
    "settings.skillsPresetSearchPlaceholder": "Search installed Skills by name",
    "settings.skillsPresetCategoryLabel": "Skill category",
    "settings.skillsPresetNoSkillsMatch": "No Skills match these filters",
