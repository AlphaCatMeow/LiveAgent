export const EN_US_COMMON_TRANSLATIONS = {
  ...
  "chat.clarify.draftLabel": "Draft",
  "chat.clarify.tabFallback": "Question",
  "chat.clarify.roundLabel": "Round {round}",
  "chat.clarify.progress": "{answered}/{total} answered",
  "chat.clarify.submit": "Submit answers",
  "chat.clarify.generate": "Generate prompt now",
  "chat.clarify.customOption": "Other (type your own)",
  "chat.clarify.customPlaceholder": "Type your thoughts…",
  "chat.clarify.multiHint": "(select all that apply)",
  "chat.clarify.recommended": "Recommended",
  "chat.clarify.skipped": "Not answered",
