export const EN_US_SETTINGS_TRANSLATIONS = {
  ...
  "settings.skillsEnvSectionTitle": "Runtime requirements",
  "settings.skillsEnvRefreshProbe": "Re-check system env",
  "settings.skillsEnvGateHint":
    "Missing {count} required environment variable(s). Configure them to enable this skill. Values are stored in local settings only.",
  "settings.skillsEnvBadgePending": "Needs setup",
  "settings.skillsEnvConfigureToEnable":
    "Configure required environment variables first — click to open details",
  "settings.skillsEnvStateUser": "Configured",
  "settings.skillsEnvStateSystem": "System env",
  "settings.skillsEnvStateMissing": "Not set",
  "settings.skillsEnvValuePlaceholder": "Paste the key or value; Enter/blur saves",
  "settings.skillsEnvValueSavedPlaceholder": "Saved •••••••• — type to replace",
  "settings.skillsEnvApplyUrl": "Get a key",
  "settings.skillsEnvSources": "Found in",
  "settings.skillsEnvClearValue": "Clear value",
  "settings.skillsEnvMarkIgnored": "Not needed",
  "settings.skillsEnvRemoveManual": "Remove",
  "settings.skillsEnvRestoreIgnored": "Restore",
  "settings.skillsEnvAdopt": "Adopt",
  "settings.skillsEnvIgnoredBadge": "Ignored",
  "settings.skillsEnvSuggestGroup": "Possible dependencies detected ({count})",
  "settings.skillsEnvEmptyHint":
    "No environment variables declared for this skill. Add them below when needed (multi-line NAME=value paste supported); values are injected into the script environment.",
  "settings.skillsEnvCardConfigure": "Configure environment variables",
  "settings.skillsEnvAddPlaceholder": "Add NAME or NAME=value; multi-line paste supported",
  "settings.skillsEnvAddAction": "Add",
