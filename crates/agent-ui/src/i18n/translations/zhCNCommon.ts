export const ZH_CN_COMMON_TRANSLATIONS = {
  ...
  "chat.skillEnvMissingTitle": "技能 {skill} 暂不可用：缺少必要环境变量",
  "chat.skillEnvOpenConfig": "去技能详情页填写",
  "chat.skillEnvUseSystem": "读取系统环境变量",
  "chat.skillEnvProbeResolved": "系统环境变量已满足要求，回复「继续」让模型重试即可。",
  "chat.skillEnvProbeAbsent": "系统环境中也未找到：{names}。请在技能详情页填写。",
