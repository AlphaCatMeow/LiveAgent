export const ZH_CN_SETTINGS_TRANSLATIONS = {
  ...
  "settings.skillsEnvSectionTitle": "运行要求",
  "settings.skillsEnvRefreshProbe": "重新检测系统环境",
  "settings.skillsEnvGateHint":
    "缺少 {count} 项必需环境变量，补齐后才能启用该技能。填写的值仅保存在本机设置中。",
  "settings.skillsEnvBadgePending": "待配置",
  "settings.skillsEnvConfigureToEnable": "需先配置必需环境变量，点击打开详情填写",
  "settings.skillsEnvStateUser": "已填写",
  "settings.skillsEnvStateSystem": "系统环境变量",
  "settings.skillsEnvStateMissing": "未配置",
  "settings.skillsEnvValuePlaceholder": "粘贴密钥或值，回车/失焦保存",
  "settings.skillsEnvValueSavedPlaceholder": "已保存 ••••••••，重新输入可覆盖",
  "settings.skillsEnvApplyUrl": "申请地址",
  "settings.skillsEnvSources": "出现于",
  "settings.skillsEnvClearValue": "清除值",
  "settings.skillsEnvMarkIgnored": "标记误报",
  "settings.skillsEnvRemoveManual": "移除",
  "settings.skillsEnvRestoreIgnored": "恢复",
  "settings.skillsEnvAdopt": "采纳",
  "settings.skillsEnvIgnoredBadge": "已忽略",
  "settings.skillsEnvSuggestGroup": "检测到的可能依赖（{count}）",
  "settings.skillsEnvEmptyHint":
    "此技能未声明环境变量。需要时在下方添加（支持粘贴多行 NAME=值），值会注入脚本运行环境。",
  "settings.skillsEnvCardConfigure": "配置环境变量",
  "settings.skillsEnvAddPlaceholder": "添加变量：NAME 或 NAME=值，可粘贴多行",
  "settings.skillsEnvAddAction": "添加",
