export const ZH_CN_SETTINGS_TRANSLATIONS = {
  ...
  "settings.builtinTool.exit_plan_mode.detail":
    "计划模式下，模型完成调研后以卡片提交完整实施计划。提交即结束该轮，计划保持待决直到你答复：批准后自动开始执行（下一轮恢复全部工具），回复其他内容则作为反馈让模型继续完善计划。仅在计划模式的对话场景注册。",
  ...
  "settings.customSettingsModelsTitle": "生成模型",
  "settings.conversationTitleModel": "标题生成模型",
  "settings.conversationTitleModelFollowCurrent": "使用当前对话模型",
  "settings.conversationTitleModelHint": "生成对话标题使用的模型，未选择时跟随当前对话模型。",
  ...
  "settings.failoverQueueHint": "按 P1 优先依次尝试，未激活当前模型的供应商会被跳过。",
  ...
  "settings.retryError.presetShort.520": "未知错误",
  "settings.retryError.presetShort.521": "服务器宕机",
  "settings.retryError.presetShort.522": "连接超时",
  "settings.retryError.presetShort.523": "源站不可达",
  "settings.retryError.presetShort.525": "SSL 握手失败",
  "settings.retryError.presetShort.526": "SSL 证书无效",
  "settings.retryError.presetShort.527": "Railgun 错误",
  "settings.retryErrorCustomPatterns": "自定义错误关键词",
  "settings.retryErrorCustomPatternsDesc": "大小写不敏感的子串，报错信息包含任一关键词即重试。",
  ...
  "settings.agentsProjectsTab": "项目提示词",
  "settings.agentsGlobalConfigTitle": "全局默认提示词",
  "settings.agentsGlobalConfigHint": "一次只能启用一个全局模板，启用新模板会自动停用当前模板。",
  "settings.agentsGlobalDefault": "全局默认",
  "settings.agentsProjectConfigured": "已配置",
  "settings.agentsProjectUnconfigured": "未配置",
  "settings.agentsProjectAppend": "拼接全局",
  "settings.agentsProjectReplace": "覆盖全局",
  "settings.agentsProjectEdit": "编辑项目提示词",
  "settings.agentsNoProjects": "还没有可配置的项目",
  "settings.agentsNoProjectsHint": "先在聊天侧栏创建或添加一个项目。",
  ...
  "settings.agentsNoTemplates": "还没有配置全局模板",
  "settings.agentsNoTemplatesHint": "创建模板并设为全局默认，在所有项目中复用常见指令",
  ...
  "settings.sshProxyUseSystemHint":
    "直接复用「系统设置 → 应用代理」的配置，无需再填写下方代理信息；应用代理关闭时将直连。",
  ...
  "settings.cuaDriver.heroChecking": "正在检测…",
  "settings.cuaDriver.heroNeedsGrant": "需要系统授权",
  "settings.cuaDriver.heroReady": "驱动已就绪",
  "settings.cuaDriver.stepInstall": "安装驱动",
  ...
  "settings.cuaDriver.confirmDesc":
    "将从 {url} 下载并执行官方安装脚本，请确认命令内容（也可复制到终端手动运行）：",
  ...
  "settings.cuaDriver.permissionsDesc":
    "需要辅助功能与屏幕录制权限，由 CuaDriver.app 独立代理持有，宿主无需提权。",
  "settings.cuaDriver.permAccessibility": "辅助功能",
  "settings.cuaDriver.permScreenRecording": "屏幕录制",
  "settings.cuaDriver.permNotGranted": "未授权",
  ...
  "settings.cuaDriver.enable": "启用 Computer Use",
  "settings.cuaDriver.disable": "停用 Computer Use",
  "settings.cuaDriver.groupSecurity": "安全与审批",
  "settings.cuaDriver.policyTitle": "工具审批策略",
  "settings.cuaDriver.policyDesc": "决定 AI 调用系统操作工具时是否需要人工审批。",
  "settings.cuaDriver.allowSelfTitle": "允许操作 LiveAgent 自身",
  "settings.cuaDriver.allowSelfDesc":
    "默认关闭，防止 AI 误操作本应用窗口或关闭设置；自动化测试自身时可开启。",
  "settings.cuaDriver.groupRuntime": "运行时配置",
  "settings.cuaDriver.timeoutLabel": "单次调用超时",
  "settings.cuaDriver.timeoutHint": "单次操作的最大等待时长。",
  "settings.cuaDriver.groupCapabilities": "能力概览",
  "settings.cuaDriver.capWindows": "窗口枚举与切换",
  "settings.cuaDriver.capScreenshot": "高精度屏幕截屏",
  "settings.cuaDriver.capMouse": "鼠标移动与点击",
  "settings.cuaDriver.capKeyboard": "键盘按键与输入",
  "settings.cuaDriver.capMenu": "原生系统菜单控制",
  "settings.cuaDriver.capBrowser": "系统浏览器联动",
  "settings.cuaDriver.policyNote":
    "操作直接作用于本地系统且不可撤销，建议在常规任务中保持「询问」模式。",
  "settings.cuaDriver.commandDriftTitle": "配置路径与探测结果不一致",
  "settings.cuaDriver.commandDriftDesc":
    "当前实际执行的是配置中的命令。若重新安装或迁移过环境，可一键对齐到最新探测路径。",
